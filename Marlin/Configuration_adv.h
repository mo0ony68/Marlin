...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300 //MOD_REM
   ...
   */
  #define BLTOUCH_HS_MODE true //MOD_REM
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  50       // (steps or mm) Steps or millimeter distance for each Z babystep
