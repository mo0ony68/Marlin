...
//#define CUSTOM_MACHINE_NAME "RI3 SKR BLT"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 20, 10000 }
...
#define XY_PROBE_FEEDRATE (150*60)  //MOD_REM

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (10*60)  //mod_rem
 ...
 */
#define DEBUG_LEVELING_FEATURE //mod_rem if not workind disalble
 ...
 */
#define NOZZLE_PARK_FEATURE //mod_rem
